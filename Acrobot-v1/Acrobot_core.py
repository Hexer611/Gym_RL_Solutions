...
import numpy as np
from tf_agents.environments import suite_gym, tf_py_environment, batched_py_environment, py_environment, batched_py_environment_test, parallel_py_environment, random_py_environment
...
class my_AI:
    ...
    def collect_steps_new(self, steps, env,policy=None):
        if policy == None:
    ...
    def train(self):
        ...
        self.env_tf.reset()
        for _ in range(5000):
            train_reward = self.collect_steps_old(100)
