This is a solution to gym/MountainCarContinuous-v0 environment using PPO agent from tf_agents library in TensorFlow.
...
The PPO agent with the parameters included in the python file, solves the 'MountainCarContinuous-v0' environment in about 129 episodes. 
I couldn't make the code to be reproducible to get the exact same results as the one included in the training_console_output. The agent sometimes learns faster sometimes slower.